...
const STRINGS: Dict = {
  ...
  "nav.constructionBudget": { English: "Construction Budget", Spanish: "Presupuesto de Construcción", Portuguese: "Orçamento de Construção" },
  ...
  "construction.categoryPlaceholder": {
    English: "Category (e.g. Gym)",
    Spanish: "Categoría (ej. Gym)",
    Portuguese: "Categoria (ex. Academia)",
  },
  "construction.uncategorized": { English: "Uncategorized", Spanish: "Sin categoría", Portuguese: "Sem categoria" },
  ...
  "construction.deleteLogConfirm": { English: "Delete this log entry? This can't be undone.", Spanish: "¿Eliminar esta entrada del registro? No se puede deshacer.", Portuguese: "Excluir este registro? Não pode ser desfeito." },
